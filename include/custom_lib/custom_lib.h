...
#ifndefTLAMANTI_APPLICATION_INCLUDE_CUSTOM_LIB_CUSTOM_LIB_H_
#defineTLAMANTI_APPLICATION_INCLUDE_CUSTOM_LIB_CUSTOM_LIB_H_
 ...
 * provided in order to have a library interfacetlamanti that is trivial
 * to test.
 *
...
#endif /*TLAMANTI_APPLICATION_INCLUDE_CUSTOM_LIB_CUSTOM_LIB_H_ */
