...
Example of a west extension in the tlamantli repository.'''

from west.commands import WestCommand  # your extension must subclass this
from west import log                   # use this for user output

class tlamantiWestCommand(WestCommand):

    def __init__(self):
        super().__init__(
            'example-west-command',               # gets stored as self.name
            'antlamanti west extension command',  # self.help
            # self.description:
            '''\
A multi-line description oftlamanti-west-command.
...
endings.''')
    ...
    def do_add_parser(self, parser_adder):
        ...
        # Add sometlamanti options using the standard argparse module API.
